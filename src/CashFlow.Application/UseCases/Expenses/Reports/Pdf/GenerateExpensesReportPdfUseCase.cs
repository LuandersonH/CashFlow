...
public class GenerateExpensesReportPdfUseCase : IGenerateExpensesReportPdfUseCase
{
    ...
    public async Task<byte[]> Execute(DateOnly month)
    {
        ...
        foreach(var expense in expenses)
        {
            ...
            if (string.IsNullOrWhiteSpace(expense.Description) == false)
            {
                ...
                descriptionRow.Cells[0].Format.Font = new Font { Name = FontHelper.WORKSANS_REGULAR, Size = 10, Color = ColorsHelper.GREEN_LIGHT };
                descriptionRow.Cells[0].Shading.Color = ColorsHelper.RED_LIGHT;
    ...
    private void CreateTotalExpenseSection(Section page, DateOnly month, decimal totalExpenses)
    {
        ...
        paragrafh.Format.SpaceBefore = "40";
        paragrafh.Format.SpaceAfter = "40";
    ...
    private void AddAmountForExpense(Cell cell, decimal expenseAmount) {
        cell.AddParagraph($"-{expenseAmount} {CURRENCY_SYOMBOL}");
